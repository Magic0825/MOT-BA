...
def adv_patch(image_set):
    ...
    mot_data_name = 'MOT17_mmtracking_poison'
    ...
    if "MOT17" in mot_data_name:
        ...
        ann_file = f"/home/zyl/ours1/datasets/{mot_data_name}/annotations/half-{image_set}_cocoformat.json"
    elif "MOT20" in mot_data_name:
        # CH+mot20-train用于训练，mot17-train用于测试
        if image_set == "train":
            img_folder = f'/home/zyl/ours1/datasets/{mot_data_name}/train'
            ann_file = f"/home/zyl/ours1/datasets/{mot_data_name}/annotations/train_cocoformat.json"
        else:
            # MOT20测试时需指定测试集路径
            img_folder = f'/home/zyl/ours1/datasets/MOT20_mmtracking_all_poison_0.05_0.005_1_dt/train'
            ann_file = f"/home/zyl/ours1/datasets/MOT20_mmtracking_all_poison_0.05_0.005_1_dt/annotations/train_cocoformat.json"
    else:
        return
    ...
    # 设置参数
    poison_rate, lr, num_steps, scale_factor, epsilon = 0.1, 0.005, 10, 1, 0.01
    # poison_rate, lr, num_steps, scale_factcd ..or, epsilon = 0.05, 0.75, 10, 0.25, 0.75
